...
# Classes
class GenericModel:
    """Class that represents the structure of the Generic Model for the creation of ARIMA models
    ...
    def _execute(self):
        """Executes the model. This method should be implemented in each ARIMA model class"""
        pass
...
class ArimaImprovedModel(GenericModel):
    ...
    def _execute(self):
        ...
        try:
            ...
            self.predictions = self.scaler.inverse_transform([self.predictions])[0]
