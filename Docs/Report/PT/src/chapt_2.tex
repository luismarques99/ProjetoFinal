...
disponíveis e pela interpretação que fornece para informar melhor o domínio do problema\cite{introduction_data_science}.\par
...
No entanto, a tendência e a sazonalidade são ocasionais\cite{timeseries_analysis_book}.\par
...
é frequentemente negligenciada\cite{introduction_machine_learning}. É muito importante, porque existem muitos problemas de
...
futuros com base em valores observados anteriormente\cite{introduction_timeseries_book}. Na figura 2.2 está representado um
...
com modelos de auto regressão\cite{introduction_deep_learning}.
...
parâmetros a serem usados para qualquer modelo\cite{introducao_data_science}. Um exemplo desta pesquisa pode ser
