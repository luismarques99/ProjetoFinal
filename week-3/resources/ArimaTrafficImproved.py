    ...
    for s_seq in prediction_list:
        ...
        for arima_parameter in arima_parameters:
            ...
            if(broke==0):
                ...
                ## Save Results
                figure_name = 'results_arima_2/'+outputfilename+'_arima(' + str(arima_parameter[0])+ ',' + str(arima_parameter[1]) + ',' + str(arima_parameter[2]) + ')_predictions_' + str(num_predictions) +'_crossvalidation_'+ str(data_split)+'_test_' + str(s_seq) +'.png' 
                ...
                results_dataset_raw.to_csv('results_arima_2/'+outputfilename+'_raw_'+'_arima(' + str(arima_parameter[0])+ ',' + str(arima_parameter[1]) + ',' + str(arima_parameter[2]) + ')_predictions_' + str(num_predictions)+'_crossvalidation_'+ str(data_split)+'_test_' + str(s_seq) +'.csv')
...
results_dataset.to_csv('results_arima_2/ARIMA_results_summary.csv', index=False, )
